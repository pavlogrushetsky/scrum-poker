...
let signUpForm = React.functionComponent("SignUpForm", fun () ->
    ...
    let message =
        ...
        | Deferred.Failed error ->
            Html.div [
                prop.className [ Sem.ui; Sem.bottom; Sem.attached; Sem.error; Sem.message ]
                prop.children [
                    Html.i [
        ...
        | Deferred.Resolved (Ok user) ->
            Html.div [
                prop.className [ Sem.ui; Sem.bottom; Sem.attached; Sem.success; Sem.message ]
                prop.children [
                    Html.i [
                        prop.className [ Sem.icon; Sem.check; Sem.circle ]
                    ]
                    Html.text (sprintf "User %s logged in" user)
                ]
            ]
        ...
        | Deferred.Resolved (Error error) ->
            Html.div [
                ...
                prop.children [
                    ...
                    Html.text (sprintf "Login error: %s" error)
                ]
            ]

    Html.div [
        prop.className [ Sem.ui; Sem.segments ]
        prop.children [
            Html.div [
                ...
                prop.children [
                    Html.div [
                        ...
                        prop.text "Welcome to Scrum Poker!"
                    ]
